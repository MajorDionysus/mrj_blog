...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Renjie Mei',
  bio: 'Undergraduate researcher in SUSTech.',
  links: [
    {
      name: 'Facebook',
      ...
      url: 'https://www.facebook.com/profile.php?id=61574133742017',
    },
    {
      name: 'Gmail',
      icon: 'fa6-brands:google',
      url: 'mailto: majorh100110@gmail.com',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/Majordionysus',
    },
    {
      name: 'ORCID',
      icon: 'fa6-brands:orcid',
      url: 'https://orcid.org/0009-0002-1648-0339',
    },
  ],
}
